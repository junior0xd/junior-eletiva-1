...
<body class="bg-dark text-light">
    <main class="container mt-5">
        <h1 class="m-4 text-center">Calcular perímetro do triângulo</h1>
        <form action="perimetro-triangulo.php" method="post" class="border rounded-2 border-light-subtle">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            echo '<h1 class="text-light text-center mt-3">Perímetro = '.$perimetro.'m</h1>';
        }
        ?>
    </main>
