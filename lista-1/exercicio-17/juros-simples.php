...
<body class="bg-dark text-light">
    <main class="container mt-5">
        <h1 class="text-center m-4">Calcular juros simples</h1>
        <form class="border rounded-2 border-light-subtle" action="juros-simples.php" method="post">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $juros = $capital + ($capital * $taxa * $periodo);
